...
impl Fp2Config for Fq2Config {
    ...
    // These functions were defined by Bls12_381, specialized for the case where nonresidue=-1. So,
    // commenting out, since they're wrong for our curve.
    /*
    #[inline(always)]
